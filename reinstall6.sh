...
set -eE
confhome=https://raw.githubusercontent.com/xiaocaitu/linux-reinstall/main
...
Manual: https://github.com/xiaocaitu/linux-reinstall
...
find_main_disk() {
    ...
    if is_in_windows; then
        ...
        if false; then
            # https://github.com/xiaocaitu/linux-reinstall/issues/76
